...
import 'ShimmerMartketWidget.dart';
                            ...
                            Expanded(
                              child: ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  MaterialColor filterColor = NumberHelper.setColorFilter(model[index].quotes![0].percentChange24h);

                                  // get price decimals fix
                                  var finalPrice = NumberHelper.removePriceDecimals(model[index].quotes![0].price);

                                  // percent change setup decimals and colors
                                  var percentChange = NumberHelper.removePercentDecimals(model[index].quotes![0].percentChange24h);

                                  Color percentColor = NumberHelper.setPercentChangesColor(model[index].quotes![0].percentChange24h);
                                  Icon percentIcon = NumberHelper.setPercentChangesIcon(model[index].quotes![0].percentChange24h);
